...
import com.vm.jms.service.OrderDetailService;
...
public class OrderDetailController {
    ...
    private static final String WELCOME_ORDER_DETAIL_ENTITY = "Welcome to Envers example: OrderAudit Detail Entity";
